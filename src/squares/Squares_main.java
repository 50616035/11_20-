...
public class Squares_main {
	...
	public static void main(String[] args) {
		...
		//double y[] = { 1.1, 1.9, 3.2, 4.3, 4.5, 5.9, 7.0 };
		...
		double value[] = new double[100];//一旦値を置いておく配列value
		...
		Graph graph = new Graph(value);
	     ...
	     //smain.writeCSV("csv/result.csv",  value);//グラフに渡したvalueを/csv/result.scvに書き込み←1/29追加分
...
public void writeCSV(String path,double[][] data) {//1/29追加分　書き込むための関数
	try {
